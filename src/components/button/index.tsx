  ...
  return (
    <button
      className={classNames(" hover:opacity-45 transition-all", {
        "bg-[#6F757C] px-3 text-[#FEF7EE] p-2 rounded-lg": variant === "gray",
        "bg-red-500 px-3 text-[#FEF7EE] p-2 rounded-lg": variant === "danger",
        "bg-yellow-500 font-bold px-3 text-[#111315] p-0.5 rounded-2xl":
          variant === "yellow",
        "bg-transparent px-3 p-2 text-[#FEF7EE] ": variant === "normal",
